...
OWNER_ID = list(map(int, getenv("OWNER_ID", "843716328").split()))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/SIArabstore")

SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/siarab_Support")
